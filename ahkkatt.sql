...
('ALA', 'Aland Islands', NULL, 'AX', NULL),
...
('ATF', 'French Southern and Antarctic Lands', NULL, 'TF', NULL),
...
('BES', 'Bonaire, Saint Eustachius and Saba', NULL, 'BQ', NULL),
...
('FLK', 'Falkland Islands', NULL, 'FK', NULL),
...
('IOT', 'British Indian Ocean Territory', NULL, 'IO', NULL),
...
('SJM', 'Svalbard and Jan Mayen', NULL, 'SJ', NULL),
('SLB', '', NULL, 'SB', NULL),
('SLE', '', NULL, 'SL', NULL),
('SLV', '', NULL, 'SV', NULL),
